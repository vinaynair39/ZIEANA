...
class Bot(object):
        ...
        if speech is not None:
            try:
                ...
                if intent == 'news':
                    ...
                    data = self.holidays.find_next()
                    count = len(data)
                    format = "The next holday is at {},  on the occasion of {} ".format(data[0], data[1])
                    self.__text_action(format)

                    if count > 2:
                        format = "and we also have a holiday at {},  on the occasion of {}".format(data[2], data[3])
                        self.__text_action(format)
                    ...
                    if entities == 'movie_stuff' and value1 == 'rating' or value2 == 'rating':
                        ...
                        try:
                            ...
                            self.__text_action("I couldn't find anything named {}. try again maybe?".format(movie_name))
                    ...
                    if entities == 'movie_stuff' and value1 == 'genre' or value2 == 'genre':
                        ...
                        try:
                            ...
                            self.__text_action("I couldn't find anything named {movie_name}. try again maybe?".format(movie_name))
                    ...
                    if entities == "something" and value1 == "something" or value2 == "something":
                        ...
                        if self.performers.playlist(music_name):
                            ...
                            self.__text_action("It looks like you don't have {} in your playlist! Shall i play you an other song?".format(music_name))
                            recognizer, audio = self.speech.listen_to_voice()
                            speech = self.speech.google_speech_recognition(recognizer, audio)
                            intent, entities, value1, value2, output = self.conversation_obj.convo(speech)
                            if intent == "yes":
    ...
    def acknowledge(self):
        ...
        time_acknowledgement = [
            "Good {}. What can I do for you?".format(self.time_of_day(date)),
    ...
    def simple_acknowledge(self):
        simple_acknoledgement = [
            "Hello, do I Know you?",
            "Hey Good Looking, do I know you?"
        ]
